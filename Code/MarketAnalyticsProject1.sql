...
/*
1.	Gsearch seems to be the biggest driver of our business. Lets pull monthly 
...
/*
3.	While we’re on Gsearch, lets you dive into nonbrand, and pull monthly sessions and orders split by device type? 
*/ 
...
Lers pull monthly trends for Gsearch, alongside monthly trends for each of our other channels?
*/ 
...
Lets pull session to order conversion rates, by month? 
...
/*
6.	For the gsearch lander test, Lets estimate the revenue that test earned us 
...
/*
7.	For the landing page test I analyzed previously, it would be great to show a full conversion funnel 
from each of the two pages to orders.Lets use the same time period you analyzed last time (Jun 19 – Jul 28).
*/ 
