...
/*
1. First, I’d like to show our volume growth. Lets pull overall session and order volume, 
...
/*
2. Next, let’s showcase all of our efficiency improvements. Lets show quarterly figures 
...
/*
3. Now lets show show how we’ve grown specific channels by pulling a quarterly view of orders 
...
by quarter and  make a note of any periods where we made major improvements or optimizations.
*/
...
/*
6. Let’s dive deeper into the impact of introducing new products. Lets pull monthly sessions to 
...
Lets pull sales data since then, and show how well each product cross-sells from one another?
*/
